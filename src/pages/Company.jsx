    ...
    <Section title="News">
      ...
      <ul className="space-y-4">
        <li className="border-b border-gray-700 pb-4">
          <h3 className="text-xl font-semibold">New AI Model Launched</h3>
          <p className="text-gray-500">August 1, 2024 — We are excited to announce the launch of our new AI model, Sentient1, with groundbreaking capabilities.</p>
        </li>
        <li className="border-b border-gray-700 pb-4">
          <h3 className="text-xl font-semibold">Partnership with XYZ Corp</h3>
          <p className="text-gray-500">July 15, 2024 — We are partnering with XYZ Corp to advance AI technology in healthcare and education sectors.</p>
        </li>
        <li>
          <h3 className="text-xl font-semibold">AI Ethics Initiative</h3>
          <p className="text-gray-500">June 20, 2024 — Launching our new AI Ethics Initiative to ensure fairness and transparency in AI development.</p>
        </li>
      </ul>
    </Section>
